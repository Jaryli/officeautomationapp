...
//        tv_to_user=(TextView)findViewById(R.id.tv_to_user);
        ...
        adapter = new GridImageAdapter(WorkTaibanActivity.this, onAddPicClickListener);
                ...
                if (selectMedia.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(WorkTaibanActivity.this).externalPicturePreview(position, selectMedia);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(WorkTaibanActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(WorkTaibanActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
...
//    private String[] items;
    ...
    private void getToUserId()
    {
        ...
        intent.setClass(WorkTaibanActivity.this, ItemContactsActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode==resultCodeNum)
        {
            ...
            if(result_value.size()>0) {
                addArchMachinePostBean.setToUser(result_value.get(0).getId());
            }
            else
            {
                addArchMachinePostBean.setToUser(0);
            }
        }
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case PictureConfig.CHOOSE_REQUEST:
                    ...
                    {
                        ImageUtil.addTimePic(selectMediabBack,WorkTaibanActivity.this);
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(WorkTaibanActivity.this)
