...
public class ProjectMiaomuBean implements Serializable {
    ...
    private String GanJing;
    private String DiJing;
    ...
    public String getGanJing() {
        return GanJing;
    }

    public void setGanJing(String ganJing) {
        GanJing = ganJing;
    }

    public String getDiJing() {
        return DiJing;
    }

    public void setDiJing(String diJing) {
        DiJing = diJing;
    }
