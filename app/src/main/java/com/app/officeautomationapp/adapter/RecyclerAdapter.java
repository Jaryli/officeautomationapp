...
import com.app.officeautomationapp.activity.ThingsGetActivity2;
...
public class RecyclerAdapter extends SecondaryListAdapter<RecyclerAdapter.GroupItemViewHolder, RecyclerAdapter.SubItemViewHolder> {
    ...
    ThingsGetActivity2 thingsGetActivity2;

    private List<DataTree<String, String>> dts = new ArrayList<>();

    public RecyclerAdapter(Context context,ThingsGetActivity2 thingsGetActivity2) {
        this.context = context;
        this.thingsGetActivity2 = thingsGetActivity2;
    }
...
//                String.valueOf(groupItemIndex), Toast.LENGTH_SHORT).show();
        thingsGetActivity2.clickItem(groupItemIndex,subItemIndex);
