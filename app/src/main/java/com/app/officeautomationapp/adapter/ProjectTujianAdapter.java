 ...
 */
public class ProjectTujianAdapter extends ArrayAdapter<ProjectTujianBean> {
    ...
    public ProjectTujianAdapter(Context context, int resource, List<ProjectTujianBean> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ProjectTujianBean approvalBean=getItem(position);//获得实例
        View view;
